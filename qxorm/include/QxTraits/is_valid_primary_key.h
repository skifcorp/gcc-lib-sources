...
template <>
struct is_valid_primary_key<QDateTime>
{ static inline bool get(const QDateTime & t) { return (t.isValid() ); } };
...
{ static inline bool get(const QVariant & t) { return ((t.type() == QVariant::String) ? qx::trait::detail::is_valid_primary_key<QString>::get(t.toString()) :
                                                                                        (! t.isNull() && (t.toLongLong() != 0 || t.toDateTime().isValid()))); } };
