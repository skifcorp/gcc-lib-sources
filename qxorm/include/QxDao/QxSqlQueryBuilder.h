...
public:
   ...
   virtual IxSqlQueryBuilder & insert(bool on_dublicate_key_update = false)
   {
      QX_SQL_BUILDER_INIT_FCT()
      qx::dao::detail::QxSqlQueryHelper_Insert<type_sql>::sql(sql, (* this), on_dublicate_key_update );

      //qDebug () << "setSqlQuery: " << sql;
      setSqlQuery(sql);
      return (* this);
   }
