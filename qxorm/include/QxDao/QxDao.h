 ...
 */
template <class T>
inline QSqlError count(long & lCount, const QString& table_name,
                       const qx::QxSqlQuery & query = qx::QxSqlQuery(),
                       QSqlDatabase * pDatabase = NULL)
{ return qx::dao::detail::QxDao_Count<T>::count(lCount, query, pDatabase, table_name); }
 ...
 */
template <class T>
inline QSqlError fetch_by_id(T & t, QSqlDatabase * pDatabase, const QString& table_name)
{ return qx::dao::detail::QxDao_FetchById<T>::fetchById(t, pDatabase, QStringList(), table_name); }
 ...
 */
template <class T>
inline QSqlError insert(T & t, QSqlDatabase * pDatabase, const QString& table_name = QString(), bool on_dublicate_key_update=false)
{ return qx::dao::detail::QxDao_Insert<T>::insert(t, pDatabase, table_name, on_dublicate_key_update); }
...
{ return qx::dao::detail::QxDao_Update<T>::update(query, t, pDatabase, QStringList(), table_name); }
 ...
 */
template <class T>
inline QSqlError create_table(QSqlDatabase * pDatabase, const QString& table_name = QString())
{ return qx::dao::detail::QxDao_CreateTable<T>::createTable(pDatabase, table_name); }
 ...
 */
template <class T>
inline QSqlError fetch_by_id(T & t, const QString& table_name)
{ return qx::dao::detail::QxDao_FetchById<T>::fetchById(t, NULL, QStringList(), table_name); }
 ...
 */
template <class T>
inline QSqlError insert(T & t, const QString& table_name = QString(), bool on_dublicate_key_update=false)
{ return qx::dao::detail::QxDao_Insert<T>::insert(t, NULL, table_name, on_dublicate_key_update); }
...
{ return qx::dao::detail::QxDao_Update<T>::update(query, t, NULL, QStringList(), table_name); }
 ...
 */
template <class T>
inline QSqlError create_table(const QString& table_name = QString())
{ return qx::dao::detail::QxDao_CreateTable<T>::createTable(NULL, table_name); }
 ...
 */
template <class T>
inline QSqlError fetch_by_id(T & t, QSqlDatabase * pDatabase, const QStringList & columns, const QString& table_name)
{ return qx::dao::detail::QxDao_FetchById<T>::fetchById(t, pDatabase, columns, table_name); }
...
inline QSqlError update_by_query(const qx::QxSqlQuery & query, T & t,
                                 ...
                                 const QString& table_name)
{ return qx::dao::detail::QxDao_Update<T>::update(query, t, pDatabase, columns, table_name); }
 ...
 */
template <class T>
inline QSqlError update_optimized(qx::dao::ptr<T> & ptr, const QString& table_name)
{ return qx::dao::detail::QxDao_Update_Optimized<T>::update_optimized("", ptr, NULL, table_name); }
 ...
 */
template <class T>
inline QSqlError update_optimized(qx::dao::ptr<T> & ptr, QSqlDatabase * pDatabase, const QString& table_name)
{ return qx::dao::detail::QxDao_Update_Optimized<T>::update_optimized("", ptr, pDatabase, table_name); }
