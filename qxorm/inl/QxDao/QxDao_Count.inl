...
struct QxDao_Count
{
   ...
   static QSqlError count(long & lCount, const qx::QxSqlQuery & query, QSqlDatabase * pDatabase, const QString& table_name)
   {
      T t; Q_UNUSED(t); lCount = 0;
      qx::dao::detail::QxDao_Helper<T> dao(t, pDatabase, "count", table_name);
