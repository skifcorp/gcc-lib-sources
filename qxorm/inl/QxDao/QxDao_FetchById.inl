...
struct QxDao_FetchById_Generic
{
   ...
   static QSqlError fetchById(T & t, QSqlDatabase * pDatabase, const QStringList & columns, const QString& table_name)
   {
      qx::dao::detail::QxDao_Helper<T> dao(t, pDatabase, "fetch by id", table_name);
...
struct QxDao_FetchById_Container
{
   ...
   static QSqlError fetchById(T & t, QSqlDatabase * pDatabase, const QStringList & columns, const QString& table_name)
   {
      ...
      qx::dao::detail::QxDao_Helper_Container<T> dao(t, pDatabase, "fetch by id", table_name);
      if (! dao.isValid()) { return dao.error(); }
...
struct QxDao_FetchById_Ptr
{
   ...
   static inline QSqlError fetchById(T & t, QSqlDatabase * pDatabase, const QStringList & columns, const QString& table_name)
   { if (! t) { qx::trait::construct_ptr<T>::get(t); }; return qx::dao::fetch_by_id((* t), pDatabase, columns, table_name); }
...
struct QxDao_FetchById
{
   ...
   static inline QSqlError fetchById(T & t, QSqlDatabase * pDatabase, const QStringList & columns, const QString& table_name)
   {
      ...
      QSqlError error = type_dao_3::fetchById(t, pDatabase, columns, table_name);
