...
Coroutine* Coroutine::build(void (*functionPointer)(), const QString& n)
{
    return new StoredFunctorCall0<void (*)()>(functionPointer, n);
}
...
Coroutine* Coroutine::build(FunctionObject functionObject, const QString& n)
{
    return new StoredFunctorCall0<FunctionObject>(functionObject, n);
}
